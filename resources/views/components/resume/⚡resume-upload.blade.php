<div class="w-full">
    ...
    <div class="bg-gradient-to-br from-slate-800 to-slate-900 rounded-xl border border-slate-700 p-8 shadow-lg">
        ...
        <!-- Form -->
        <form wire:submit="submitResume" class="space-y-6">
            ...
            <div class="relative">
                <div class="border-2 border-dashed border-slate-600 rounded-xl p-12 text-center transition hover:border-blue-500 hover:bg-blue-500/5 cursor-pointer"
                    ...
                    <input type="file" wire:model="resume_file" accept=".pdf,.doc,.docx" class="hidden" id="fileInput">
                ...
                @if ($resume_file)
                    <div class="mt-4 p-4 bg-green-500/10 border border-green-500/30 rounded-lg flex items-center gap-3">
                        ...
                        <div>
                            <p class="text-green-400 font-medium text-sm">{{ $resume_file->getClientOriginalName() }}</p>
            ...
            <div>
                ...
                <input type="text" id="title" wire:model="title" placeholder="e.g., Senior Backend Developer - 2024"
            ...
            @if ($message && str_contains($message, '✓'))
                <div class="p-4 bg-green-500/15 border border-green-500/40 rounded-lg">
            ...
            <!-- Error Message -->
            @if ($message && str_contains($message, '✗'))
                <div class="p-4 bg-red-500/15 border border-red-500/40 rounded-lg">
                ...
                @foreach ($resumes as $resume)
                    <div
                        ...
                        <div class="flex-1">
                            ...
                            <div class="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-slate-500 text-xs mt-1">Added {{ $resume->created_at->diffForHumans() }}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="flex gap-2 opacity-0 group-hover:opacity-100 transition">
                            ...
                            <button type="button" wire:click="delete({{ $resume->id }})" wire:confirm="Delete this resume?"
    ...
    @else
        ...
        <div class="mt-12 text-center py-12 bg-slate-800/30 rounded-xl border border-slate-700 border-dashed">
            <svg class="h-16 w-16 text-slate-500 mx-auto mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                    d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
            </svg>
