<x-layouts.dashboard-layout title="Recruiter dashboard" heading="Hiring workspace"
    ...
    <div class="grid gap-4 sm:grid-cols-3">
        ...
        <div class="rounded-2xl border border-slate-800 bg-slate-900/70 p-5">
            <p class="text-sm text-slate-400">Candidates reviewed</p>
            <p class="mt-2 text-3xl font-bold text-white">0</p>
        </div>
        <div class="rounded-2xl border border-slate-800 bg-slate-900/70 p-5">
    ...
    <div class="mt-8 grid gap-4 md:grid-cols-2">
        <a href="{{ route('dashboard.recruiter.bulk-upload') }}"
            ...
            <p class="text-sm font-semibold text-blue-300">START A REVIEW</p>
            <h2 class="mt-3 text-xl font-bold text-white">Upload candidate resumes</h2>
            <p class="mt-2 text-sm leading-6 text-slate-400">Add resumes and a target job description to prepare a
                ranked review.</p>
        </a>
        <a href="{{ route('dashboard.recruiter.candidates') }}"
            ...
            <p class="text-sm font-semibold text-indigo-300">PIPELINE</p>
            <h2 class="mt-3 text-xl font-bold text-white">View candidates</h2>
            <p class="mt-2 text-sm leading-6 text-slate-400">Review ranking, skill alignment, and key gaps from one
                workspace.</p>
        </a>
    </div>
