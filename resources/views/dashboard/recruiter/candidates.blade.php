<x-layouts.dashboard-layout title="{{ __('Candidates') }}" heading="{{ __('Candidate rankings') }}" description="{{ __('Your analyzed candidates will appear here, ordered by match quality.') }}">
