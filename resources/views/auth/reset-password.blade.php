<x-layouts.app-layout pageTitle="Choose a new password" pageHeading="Set a new password"
    pageDescription="Choose a strong password you have not used before.">
    <div class="mx-auto max-w-md rounded-2xl border border-slate-700/80 bg-slate-900/70 p-6 shadow-2xl shadow-black/20 sm:p-8">
        ...
        <h2 class="mt-2 text-2xl font-bold text-white">Create a new password</h2>
        <form method="POST" action="{{ route('password.update') }}" class="mt-6 space-y-5">
            ...
            <button type="submit" class="w-full rounded-lg bg-gradient-to-r from-blue-500 to-indigo-600 px-4 py-3 font-semibold text-white transition hover:from-blue-400 hover:to-indigo-500">Reset password</button>
        </form>
    </div>
