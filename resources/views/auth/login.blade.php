<x-layouts.app-layout pageTitle="Sign in" pageHeading="Welcome back"
    pageDescription="Continue building a sharper hiring profile.">
    ...
    <div class="mx-auto grid max-w-5xl gap-8 md:grid-cols-2 lg:items-center">
        ...
        <section
            ...
            <h2 class="mt-4 text-4xl font-bold tracking-tight text-white">Make every application count.</h2>
            <p class="mt-4 max-w-md leading-7 text-slate-300">Analyze your resume, spot improvement opportunities, and
                present your strongest work.</p>
            <div class="mt-8 space-y-4 text-sm text-slate-300">
                <p>✓ AI-guided resume feedback</p>
                <p>✓ ATS-focused improvements</p>
                <p>✓ Candidate review tools</p>
            </div>
        </section>
        ...
        <form method="POST" action="{{ route('login') }}"
            ...
            @csrf
            <p class="text-sm font-semibold uppercase tracking-[0.18em] text-blue-400">Secure sign in</p>
            <h2 class="mt-2 text-2xl font-bold text-white">Sign in to Resume AI</h2>
            <p class="mt-1 text-sm text-slate-400">Enter your details to continue.</p>
            ...
            <div class="mt-6 space-y-5">
                ...
                <div>
                    <div class="mb-2 flex items-center justify-between">
                        ...
                        <a href="{{ route('password.request') }}"
                            class="text-sm font-medium text-blue-400 hover:text-blue-300">Forgot password?</a>
                    </div>
                ...
                <button type="submit"
                    class="w-full rounded-lg bg-gradient-to-r from-blue-500 to-indigo-600 px-4 py-3 font-semibold text-white shadow-lg shadow-blue-950/40 transition hover:from-blue-400 hover:to-indigo-500 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-offset-2 focus:ring-offset-slate-900">Sign
                    in</button>
            </div>
            <p class="mt-6 text-center text-sm text-slate-400">New to Resume AI? <a href="{{ route('register') }}"
                    class="font-semibold text-blue-400 hover:text-blue-300">Create an account</a></p>
        </form>
    </div>
